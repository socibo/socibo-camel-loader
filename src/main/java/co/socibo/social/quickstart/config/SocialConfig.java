...
import co.socibo.social.quickstart.user.SecurityContext;
import co.socibo.social.quickstart.user.SimpleConnectionSignUp;
import co.socibo.social.quickstart.user.SimpleSignInAdapter;
